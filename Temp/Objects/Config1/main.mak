...
export WIN32_AS_PROJECT_PATH := "D:\Projekty BER\Embraco_PracoviskoPopisovaniaStatorovLaserom_A2019050"
export WIN32_AS_SYSTEM_PATH := "C:\BrAutomation\AS\System"
export WIN32_AS_VC_PATH := "C:\BrAutomation\AS47\AS\VC"
export WIN32_AS_TEMP_PATH := "D:\Projekty BER\Embraco_PracoviskoPopisovaniaStatorovLaserom_A2019050\Temp"
export WIN32_AS_BINARIES_PATH := "D:\Projekty BER\Embraco_PracoviskoPopisovaniaStatorovLaserom_A2019050\Binaries"
...
ProjectMakeFile:
	...
	@'$(AS_BIN_PATH)/BR.AS.AnalyseProject.exe' '$(AS_PROJECT_PATH)/Embraco_PracoviskoPopisovaniaLaserom.apj' -t '$(AS_TEMP_PATH)' -c '$(AS_CONFIGURATION)' -o '$(AS_BINARIES_PATH)'   -sfas -buildMode 'BuildAndTransfer'   
